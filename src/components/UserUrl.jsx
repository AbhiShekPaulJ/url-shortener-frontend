...
const UserUrl = () => {
  ...
  if (!urls.urls || urls.urls.length === 0) {
    return (
      <div className="text-center text-gray-500 my-6 p-4 bg-gray-500 rounded-lg border border-gray-200">
  ...
  return (
    <div className="bg-zinc-700 rounded-lg mt-5 shadow-md overflow-hidden">
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-gray-700 divide-y divide-gray-200">
            {urls.urls.reverse().map((url) => (
              <tr key={url._id} className="hover:bg-gray-600">
                <td className="px-6 py-4">
                  <div className="text-sm text-white font-thin truncate max-w-xs">
                    {url.full_url}
                  </div>
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4">
                  <div className="text-sm text-gray-900">
                    <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                      {url.clicks} {url.clicks === 1 ? 'Visit' : 'Visits'}
                    </span>
                  </div>
                </td>
